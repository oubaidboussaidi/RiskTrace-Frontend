 ...
 * ─────────────────────────────────────────────────────────────────────────────
 * Contains all ready-to-copy integration snippets for every supported backend
 * platform. The API key and endpoint are injected at call time.
 *
 * To add a new platform:
 *  1. Add an entry to INTEGRATION_TABS
 *  2. Add a matching case in getSnippet()
 * ─────────────────────────────────────────────────────────────────────────────
 */
...
/**
 * Returns the integration snippet for a given platform.
 * @param tabId     - The tab identifier (e.g. 'nodejs', 'spring')
 * @param apiKey    - The site's API key (injected into the snippet)
 * @param endpoint  - The RiskTrace collect endpoint URL
 */
